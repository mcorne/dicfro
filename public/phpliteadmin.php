<?php
//      phpLiteAdmin customized for DicFro
//
...
<title>DicFro - <?php echo PROJECT ?></title>
...
else //user is authorized - display the main application
{
    ...
    echo "<div id='leftNav'>";
    echo "<h1><a href='".PAGE."'>";
    echo "<span id='logo'>DicFro&nbsp;Database&nbsp;Admin<br/>";
    ...
    echo "<a href='".get_dicfro_url()."'>Back to DicFro</a> | ";
